...
if __name__ == "__main__" :
    ...
    async def help_message(app, message):
        await message.reply_text("check @seriez_encoded and @Anime_Complex for Anime Series", quote=True)
